---
source01: https://www.reddit.com/r/Unity3D/comments/1s6czv/inspectorbutton_add_a_custom_button_to_your/
---
# Example 
```
public class InspectorButtonTest : MonoBehaviour // ScriptableObjects //also work
{
...
Just paste this script into your asset folder:
```
using UnityEngine;
#if UNITY_EDITOR
using UnityEditor;
