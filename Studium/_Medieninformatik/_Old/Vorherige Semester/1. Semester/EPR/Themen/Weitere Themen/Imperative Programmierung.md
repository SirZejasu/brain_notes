...
# Sequenz
- Anweisungen in geschachtelte Blöcken
- Deklarierte Variablen, außerhalb von Blöcken, können innerhalb der Blöcke geändert und in anderen verwendet werden.
- In Blöcken deklarierte Variablen können weder zugegriffen noch verändert werden.

# Alternativ-Anweisung
- Anweisungen mit Bedingungen
- Anwendung von If-Else Syntax


# While-Schleife
- Bedingter Ausdruck
- Führt eine Anweisung, solange der boolescher Parameterwert war ist.
- Sobald der Wert falsch ist, wird die Anweisung ein letztes Mal ausgeführt.
